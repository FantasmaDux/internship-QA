...
| Получение объявления по его идентификатору      | 2                | 3                | 1            | 6                            | 1                      | 7     |
| Получение объявлений по идентификатору продавца | 2                | 2                | 1            | 5                            | 2                      | 7     |
| Получение статистики                            | 1                | 3                | 1            | 5                            | 1                      | 6     |

**Всего тест-кейсов написано:** 37
...
**Описание**: создание объявления с валидными параметрами с минимальным граничным значением sellerID
...
**Описание**: создание объявления с валидными параметрами с максимальным граничным значением sellerID
...
- Написан скрипт для нагрузочного тестирования с 3-мя параллельными пользователями и 30-ью итерациями
...
**Описание**: получение объявлений по ID продавца без объявлений
...
**Тестовые данные**:
```
path variable: 7b32ebda-b357-4101-bd4c-869a0ed32201 {идентификатор несуществующего объявления}
```
...
<details><summary><h4 style="display: inline; ">Тест-кейс получения статистики для объявления с изменённым порядком полей</h4></summary>
...
**Предусловия**: 
- Объявление создано с изменённым порядком полей ("viewCount", "contacts", "likes")
