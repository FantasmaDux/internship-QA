...
<details><summary><h4 style="display: inline; ">Тест-кейс получения объявлений по несуществующему ID продавца</h4></summary>

**Идентификатор**: TC_GABS_02

**Приоритет**: средний

**Описание**: получение объявлений по несуществующему ID продавца

**Тестовые данные**:
```
path variable: 997999 {идентификатор несуществующего продавца}
```
...
| Номер шага | Шаг                                                      | Ожидаемый результат                               |
|------------|----------------------------------------------------------|---------------------------------------------------|
| 1          | Отправить GET запрос получения объявлений по ID продавца | Получен код 404 NOT FOUND                         |
| 2          | Проверить тело ответа                                    | Тело ответа содержит поясняющую ошибку информацию |
