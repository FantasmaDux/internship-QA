...
public class CreateAdEndpointTests {
    ...
    @Test
    @DisplayName("Создание объявления с валидными параметрами и минимальным граничным значением sellerID")
    @Description("Проверка, что объявление успешно создаётся с корректными параметрами " +
    ...
    @Test
    @DisplayName("Создание объявления с валидными параметрами и максимальным граничным значением sellerID")
    @Description("Проверка, что объявление успешно создаётся" +
    ...
    @Description("Проверка, что при попытке создать объявление " +
    ...
    @Description("Проверка, что при попытке создать объявление с отрицательными полями " +
    ...
    @Description("Проверка, что при попытке создать объявление с отрицательными sellerId " +
    ...
    @Description("Проверка, что при попытке создать объявление с пустым названием " +
            "будет возвращен статус-код 400")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Description("Проверка, что при попытке создать объявление c отсутствующим полем " +
            "будет возвращен статус-код 400")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Description("Проверка, что при попытке создать объявление c методом GET " +
    ...
    @Description("Проверка, что при повторном создании объявления с одинаковыми данными " +
    ...
    @Description("Проверка, что внедрение вредоносной строки (sql injection) в поле name не " +
    ...
    @Description("Проверка, что внедрение XSS-атаки в поле name не " +
            "вызовет необычного поведения")
    @Severity(SeverityLevel.NORMAL)
