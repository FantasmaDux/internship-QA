...
public class E2ETests {
  ...
  @Description(
      "Проверка стандартной последовательности действий при работе с корректно созданным объявлением")
  ...
  @Description(
      "Проверка, что при создании объявления с валидными параметрами оно"
  ...
  @Description(
      "Проверка, что при создании нескольких объявлений с валидными параметрами все "
  ...
  public void createAndGetAdsBySellerIdTest() {
    ...
    for (String expectedId : adIds) {
      found = ads.stream().anyMatch(ad -> ad.getId().toString().equals(expectedId));
      if (!found) {
        break;
      }
    }
