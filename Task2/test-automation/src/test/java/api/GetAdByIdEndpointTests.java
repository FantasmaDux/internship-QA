...
public class GetAdByIdEndpointTests {
  ...
  @Description(
      "Проверка, что для по запросу возвращает существующее объявление со статус-кодом 200")
  ...
  @Description(
      "Проверка, что при попытке получить несуществующее объявление возвращается статус-код 404")
  ...
  @Description(
      "Проверка, что при попытке получить объявление с невалидной формой ID"
  ...
  @Description(
      "Проверка, что при попытке получить объявление c методом POST "
