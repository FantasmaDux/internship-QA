...
public class GetAdsBySellerIdEndpointTests {
  ...
  public void getRequestIdempotencyTest() {
    ...
    List<AdResponseDto> secondResponses =
        secondResponse.jsonPath().getList(".", AdResponseDto.class);
  ...
  @Description(
      "Проверка, что внедрение XSS-атаки в поле sellerId не " + "вызовет необычного поведения")
  @Severity(SeverityLevel.NORMAL)
