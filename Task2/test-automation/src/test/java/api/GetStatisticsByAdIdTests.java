...
public class GetStatisticsByAdIdTests {
  ...
  public void getExistingAdStatisticTest() {
    ...
    List<StatisticResponseDto> statisticsList =
        response.jsonPath().getList(".", StatisticResponseDto.class);
  ...
  @Description(
      "Проверка, что порядок полей статистики при создании объявления не повлияет"
  ...
  @Description(
      "Проверка, что повторные GET-запросы возвращают "
  ...
  public void getRequestIdempotencyTest() {
    ...
    List<StatisticResponseDto> firstStatisticList =
        firstResponse.jsonPath().getList(".", StatisticResponseDto.class);
    ...
    List<StatisticResponseDto> secondStatisticList =
        secondResponse.jsonPath().getList(".", StatisticResponseDto.class);
    ...
    List<StatisticResponseDto> thirdStatisticList =
        thirdResponse.jsonPath().getList(".", StatisticResponseDto.class);
